...
public class CommentController {
    ...
    public ResponseEntity<?> createFeedback(@RequestBody CreateFeedbackRequest request) {
        try {
            treatmentService.createFeedback(request.getDiagnoseId(), request.getTreatmentScore(),
...
// public ResponseEntity<?> getAllFeedbacks()
// {
// List<TreatmentFeedbacksResponse> feedbacks =
// treatmentService.getAllFeedbacks().stream()
// .map(tf -> new TreatmentFeedbacksResponse(
// tf.getDiagnosedid(),
// tf.getPatientId(),
// tf.getDoctorId(),
...
// @PostMapping("/CreateFeedback")
// @CrossOrigin
// public ResponseEntity<?> createFeedback(@RequestBody CreateFeedbackRequest
// request) {
// try {
// treatmentService.createFeedback(request.getDiagnoseId(),
// request.getTreatmentScore(), request.getEvaluation());
// return ResponseEntity.ok("Treatment feedback created successfully.");
// } catch (Exception e) {
// return ResponseEntity.badRequest().body(e.getMessage());
// }
