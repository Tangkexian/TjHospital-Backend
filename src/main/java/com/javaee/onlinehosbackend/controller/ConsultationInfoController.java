...
public class ConsultationInfoController {
    ...
    @GetMapping
    @CrossOrigin
    public ResponseEntity<?> getConsultationInfoByDepartmentAndKeyword(@RequestParam String department,
            @RequestParam(required = false) String keyword) {
        List<DoctorConsultationInfoResponse> result = consultationInfoService
                .getConsultationInfoByDepartmentAndKeyword(department, keyword);
        if (result.isEmpty()) {
...
// getConsultationInfoByDepartmentAndKeyword(@RequestParam String department,
// @RequestParam(required = false) String keyword) {
// List<DoctorConsultationInfoResponse> result =
// consultationInfoService.getConsultationInfoByDepartmentAndKeyword(department,
// keyword);
// if (result.isEmpty()) {
// return ResponseEntity.ok("empty");
// }
...
// @CrossOrigin
// public ResponseEntity<?> getAllConsultInfo() {
// List<ConsultationInfoResponse> responses =
// consultationInfoService.getAllConsultationInfos();
// if (responses.isEmpty()) {
// return ResponseEntity.notFound().build();
// }
// return ResponseEntity.ok(responses);
...
// @PutMapping("/ChangeConsult")
// @CrossOrigin
// public ResponseEntity<?> changeConsultInfo(@RequestBody ChangeConsultRequest
// changeConsultRequest) {
// String response =
// consultationInfoService.changeConsultInfo(changeConsultRequest);
// return ResponseEntity.ok(response);
// }

// @PutMapping("/CancelConsult")
// @CrossOrigin
// public ResponseEntity<?> cancelConsultInfo(@RequestBody ConsultCancelRequest
// consultCancelRequest) {
// String response =
// consultationInfoService.deleteConsultationInfo(consultCancelRequest);
// if (response.equals("No matching ConsultationInfo found to delete.")) {
// return ResponseEntity.notFound().build();
// }
// return ResponseEntity.ok(response);
...
// @PostMapping("/AddConsult")
// @CrossOrigin
// public ResponseEntity<?> addConsultInfo(@RequestBody ConsultRequest
// consultRequest) {
// try {
// String result = consultationInfoService.addConsultInfo(consultRequest);
// return ResponseEntity.ok(result);
