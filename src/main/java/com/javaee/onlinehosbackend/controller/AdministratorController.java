...
// @CrossOrigin
// public ResponseEntity<?> getAdministrators() {
// List<AdministratorResponse> administratorResponseList =
// administratorService.getAllAdministrators().stream()
// .map(tf -> new AdministratorResponse(
// tf.getAdministratorId(),
// tf.getName(),
// tf.getGender(),
...
// public ResponseEntity<?> getAdministratorbyName(@RequestParam String name) {
// List<AdministratorResponse> administratorResponseList =
// administratorService.getAdministratorByName(name).stream()
// .map(tf -> new AdministratorResponse(
// tf.getAdministratorId(),
// tf.getName(),
// tf.getGender(),
...
// @PostMapping("/add")
// @CrossOrigin
// public ResponseEntity<?> addAdministrator(@RequestBody Administrator
// administrator) {
// if (administratorService.existsById(administrator.getAdministratorId())) {
// return ResponseEntity.badRequest().body("Administrator with ID " +
// administrator.getAdministratorId() + " already exists.");
// }
// Administrator newAdmin =
// administratorService.addAdministrator(administrator);
// return ResponseEntity.created(URI.create("/api/administrators/" +
// newAdmin.getAdministratorId())).body(newAdmin);
// }

// @PutMapping("/update")
// @CrossOrigin
// public ResponseEntity<?> updateAdministrator(@RequestBody Administrator
// administrator) {
// try {
